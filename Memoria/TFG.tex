...
Buscando alternativas, encontré \Gls{PAM}. Cuando averigüé que era la forma por defecto de autenticación de usuarios en la mayoría de sistemas \Gls{GNU/Linux} y vi que ya estaba diseñada para permitir múltiples factores de autenticación, supe que usar PAM era el camino que debía seguir.
